...
export class JobDetailsComponent implements OnInit {
  ...
  public getRelatedJobs(): any {
    if (this.job && this.job.publishedCategory) {
      this.service.getjobs({ 'publishedCategory.id': [this.job.publishedCategory.id]}, {} , SettingsService.settings.service.batchSize, this.job.service).subscribe((res: any) => { this.relatedJobs = res.data; });
    }
  }
