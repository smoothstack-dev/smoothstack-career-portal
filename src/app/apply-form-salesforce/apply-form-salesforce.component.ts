  ...
  public save(): void {
    if (this.form.valid) {
      ...
      switch (this.formType) {
        case 'BUILD':
          requestParams = {
            oid: encodeURIComponent('00Df4000004JCvU'),
            retURL: encodeURIComponent('http://localhost:4200'),
            '00N5G00000VGNrS': encodeURIComponent('Contact Us'),
            country: encodeURIComponent('United States'),
            first_name: encodeURIComponent(this.toTitleCase(this.form.value.firstName.trim())),
            last_name: encodeURIComponent(this.toTitleCase(this.form.value.lastName.trim())),
            email: encodeURIComponent(this.form.value.email.trim()),
            phone: encodeURIComponent(this.form.value.phoneNumber.trim()),
            title: encodeURIComponent(this.form.value.title.trim()),
            company: encodeURIComponent(this.form.value.company.trim()),
            state: encodeURIComponent(this.form.value.location),
            Comments__c: encodeURIComponent(this.form.value.comment.trim()),
          };
          break;
        case 'RECRUIT':
          requestParams = {
            ...
            phone: encodeURIComponent(this.form.value.phoneNumber.trim()),
            title: encodeURIComponent(this.form.value.title.trim()),
            organizationName: encodeURIComponent(this.form.value.organizationName),
            Organization_Type__c: encodeURIComponent(this.form.value.typeOfOrganization),
            state: encodeURIComponent(this.form.value.location),
            Comments__c: encodeURIComponent(this.form.value.comment.trim()),
          };
          break;
